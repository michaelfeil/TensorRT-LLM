...
void tb::kv_cache_manager::KVCacheManagerBindings::initBindings(nb::module_& m)
{
    ...
    nb::class_<tbk::BaseKVCacheManager, PyKvCacheManager>(m, "BaseKVCacheManager")
        ...
        .def("get_needed_blocks_one_step", &BaseKVCacheManager::getNeededBlocksOneStep, nb::arg("req"),
            ...
            nb::call_guard<nb::gil_scoped_release>())
        .def("set_spec_scheduling_tokens", &BaseKVCacheManager::setSpecSchedulingTokens,
            nb::arg("reserved_draft_tokens_per_step"), nb::arg("num_extra_kv_tokens"))
        .def("set_reserve_ahead_tokens", &BaseKVCacheManager::setReserveAheadTokens, nb::arg("reserve_ahead_tokens"))
        ...
        .def(
            ...
            nb::call_guard<nb::gil_scoped_release>())
        .def(
            "get_unique_secondary_pool", [](tbk::BaseKVCacheManager& self) { return self.getUniqueSecondaryPool(); },
            nb::call_guard<nb::gil_scoped_release>())
        ...
        .def("sync_transfer_manager_with_buffer_manager", &BaseKVCacheManager::syncTransferManagerWithBufferManager,
            nb::call_guard<nb::gil_scoped_release>())
        .def("flush_pending_persistence_retirements", &BaseKVCacheManager::flushPendingPersistenceRetirements,
            nb::call_guard<nb::gil_scoped_release>())
        ...
        .def("commit_and_get_block_hashes_for_request_range",
            &BaseKVCacheManager::commitAndGetBlockHashesForRequestRange, nb::arg("llm_request"), nb::arg("window_size"),
            nb::arg("first_block_index"), nb::call_guard<nb::gil_scoped_release>());
    ...
    nb::class_<tbk::KVCacheManager, tbk::BaseKVCacheManager>(m, "KVCacheManager")
        .def(nb::init<std::vector<SizeType32> const&, SizeType32, SizeType32,
            ...
            nb::arg("copy_on_partial_reuse") = true, nb::arg("enable_tp_mla_replicated_host_offload") = false,
            nb::arg("tp_group_ranks") = std::vector<SizeType32>{}, nb::arg("kv_connector_manager") = nullptr,
