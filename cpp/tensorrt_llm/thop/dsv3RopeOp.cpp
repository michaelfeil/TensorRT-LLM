...
struct MlaRopeGenArgs
{
    ...
    int32_t const* gen_cu_q_seqlens_ptr;
};
    ...
    KVCacheBuffer& kv_cache_buffer, MlaRopeGenArgs const& args, cudaStream_t stream)
{
    ...
    mla_params.gen_cu_q_seqlens = args.gen_cu_q_seqlens_ptr;
    ...
    std::optional<torch::Tensor> gen_cu_q_seqlens)
{
    ...
    int32_t const* gen_cu_q_seqlens_ptr
        = gen_cu_q_seqlens.has_value() ? gen_cu_q_seqlens->data_ptr<int32_t>() : nullptr;
